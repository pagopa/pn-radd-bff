...
public class PnRaddBffExceptionCodes extends PnExceptionsCodes {
    ...
    public static final String ERROR_CODE_DOCUMENT_READY = "PN_RADD_BFF_DOCUMENT_NOT_FOUND";
    public static final String ERROR_MESSAGE_DOCUMENT_READY = "Errore durante la chiamata al servizio getDocument di pn-radd-fsu";
