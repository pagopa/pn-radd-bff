...
import static it.pagopa.pn.radd.bff.exception.PnRaddBffExceptionCodes.ERROR_CODE_DOCUMENT_READY;
...
public class HandleEventUtils {
    ...
    public static StandardEventHeader mapStandardEventHeader(MessageHeaders headers) {
        if (headers != null) {
            ...
            log.error(msg);
            throw new PnInternalException(msg, ERROR_CODE_DOCUMENT_READY);
        }
    }
